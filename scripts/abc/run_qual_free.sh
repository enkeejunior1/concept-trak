...
PROMPT="${PROMPT:-Pikachu in the style of Pablo Picasso}"
NEGATIVE_PROMPT="${NEGATIVE_PROMPT:-}"
TARGET_CONCEPTS="${TARGET_CONCEPTS:-Pikachu,Pablo Picasso}"
NEGATIVE_PROMPTS="${NEGATIVE_PROMPTS:-in the style of Pablo Picasso,Pikachu}"
SEED="${SEED:-0}"
LAYER="${LAYER:-attn2}"
F="${F:-dps}"
